...
Se usaron el joint de polea para que pudiera empujar la segunda bola y el joint de revolucion, para que cuando la bola caiga con los circulos no se atore y pueda seguir.

Primero se crean las clases que se usaran, Cube y Circle, y en main se van colocando todas las plataformas y circulos.
Primero se crean los circulos dinamicos, uno iniciara el mecanismo y el otro terminara el camino.

Los siguientes 6 circulos son los que tendran los joints de revolucion y haran que el segundo circulo pueda seguir avanzando.

Luego se crean todas las plataformas que se usaran, como no se moveran son estaticas.

Despues se crean las plataformas de la polea, estas tendran el joint de polea que hara que una plataforma baje para que la otra pueda subir y empujar el segundo circulo.

Al final se crean los rectangulos que iniciaran la cadena, pero esta vez dinamicos para que el circulo los pueda empujar.

El joint de "Pulley" se uso en las plataformas y en las anclas de la polea.

Se crearon 3 joints de "Revolute" para cada uno de los circulos, cambiando "bodyA", "bodyB", "goundAnchorA", "groundAnchorB",  "anchorA" y "anchorB" respectivamente.
