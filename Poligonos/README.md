...
Crear un triangulo, rectangulo, cuadrado, pentagono, hexagono y octagono usando PolygonShape.
PolygonShape es una clase de Box2D que sirve para crear formas poligonales para usarse como colisionadores para cuerpos.
```
#include <iostream>  
